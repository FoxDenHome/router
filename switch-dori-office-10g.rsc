# jan/19/2023 19:16:19 by RouterOS 7.7
# software id = REMOVED
#
# model = CRS305-1G-4S+
# serial number = REMOVED
/interface bridge add admin-mac=18:FD:74:7B:0C:B9 auto-mac=no name=bridge priority=0xA000 vlan-filtering=yes
/interface ethernet set [ find default-name=ether1 ] advertise=100M-full,1000M-full l2mtu=9092 mtu=9000 name=eth1-switch-dori-office rx-flow-control=on tx-flow-control=on
...
/interface ethernet set [ find default-name=sfp-sfpplus2 ] advertise=1000M-full,10000M-full l2mtu=9092 mtu=9000 name=sfp2 rx-flow-control=on speed=10Gbps tx-flow-control=on
/interface ethernet set [ find default-name=sfp-sfpplus3 ] advertise=1000M-full,10000M-full l2mtu=9092 mtu=9000 name=sfp3 rx-flow-control=on speed=10Gbps tx-flow-control=on
...
/interface bridge port add bridge=bridge ingress-filtering=no interface=eth1-switch-dori-office multicast-router=disabled
...
/interface bridge port add bridge=bridge frame-types=admit-only-untagged-and-priority-tagged interface=sfp3 multicast-router=disabled pvid=2
...
/interface bridge vlan add bridge=bridge untagged=bridge,sfp4-switch-rack-agg,eth1-switch-dori-office vlan-ids=1
/interface bridge vlan add bridge=bridge tagged=bridge,sfp4-switch-rack-agg,eth1-switch-dori-office vlan-ids=2
/interface bridge vlan add bridge=bridge tagged=sfp4-switch-rack-agg,bridge,eth1-switch-dori-office vlan-ids=3
/interface bridge vlan add bridge=bridge tagged=bridge,sfp4-switch-rack-agg,eth1-switch-dori-office vlan-ids=4
/interface bridge vlan add bridge=bridge tagged=bridge,sfp4-switch-rack-agg,eth1-switch-dori-office vlan-ids=5
/interface bridge vlan add bridge=bridge tagged=bridge,sfp4-switch-rack-agg,eth1-switch-dori-office vlan-ids=6
...
/tool sniffer set filter-interface=eth1-switch-dori-office filter-mac-protocol=lldp
