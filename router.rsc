...
/interface ethernet set [ find default-name=sfp-sfpplus7 ] comment=sfp7 name=auth rx-flow-control=on tx-flow-control=on
...
/ip dhcp-server option sets add name=nothing options=""
/ip dhcp-server option sets add name=default-noclassless options=""
/ip pool add name=pool-mgmt ranges=10.1.100.0-10.1.149.255
/ip pool add name=pool-lan ranges=10.2.100.0-10.2.149.255
/ip pool add name=pool-dmz ranges=10.3.100.0-10.3.149.255
/ip pool add name=pool-labnet ranges=10.4.100.0-10.4.149.255
...
/ip pool add name=pool-auth ranges=10.77.77.100-10.77.77.150
...
/ip dhcp-server add address-pool=pool-mgmt dhcp-option-set=default-classless interface=vlan-mgmt lease-time=1h name=dhcp-mgmt
...
/interface ovpn-server server add mac-address=FE:A4:C2:0E:C6:83 name=ovpn-server1
...
/interface wireguard peers add allowed-address=10.100.10.7/32 client-address=10.100.10.7/16 client-dns=10.100.0.1 client-endpoint=vpn.foxden.network client-keepalive=2m client-listen-port=13231 interface=wg-vpn name=wizzy-iphone private-key="REMOVED" public-key="/v/zZ/76334XDEO/srIo5pGD6Oe/y9HSmmy1vRahZDM=" responder=yes
...
/ip address add address=10.69.69.1/24 interface=auth network=10.69.69.0
...
/ip service set www-ssl certificate=router.foxden.network disabled=no tls-version=only-1.2
/ip service set api disabled=yes
/ip service set winbox address=10.0.0.0/8
/ip service set api-ssl certificate=*8 tls-version=only-1.2
...
/ipv6 nd add advertise-dns=no interface=vlan-labnet ra-interval=1m-3m ra-preference=high
/ipv6 nd add advertise-dns=no interface=vlan-lan ra-interval=1m-3m ra-preference=high
